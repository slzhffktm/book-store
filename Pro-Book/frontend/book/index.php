...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/tugasbesar1_2018/frontend/book/book.css">
    </head>
    <body>
        ...
        <div class="container" id="content">
            <div class="row" id="first-row">
                ...
                <div class="kolom-md-10">
                    ...
                    <form style="width: 100%;" name="search_book" action="/tugasbesar1_2018/index.php/Book/searchBook" method="get">
